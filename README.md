...
<p align="left"><img width="100%" src="./images/parametro_7.png"></p>

Add a new parameter in Power Query:
<p align="left"><img width="50%" src="./images/parametro_1.png"></p>

Add the name of the parameter, the type as text and the filepath of the data: 
<p align="left"><img width="100%" src="./images/parametro_2.png"></p>

In origin configurations, select the parameter created in the route:
<p align="left"><img width="50%" src="./images/parametro_3.png"></p>
...
Data 2:
<p align="left"><img width="100%" src="./images/template_2.png"></p>
...
<p align="left"><img width="100%" src="./images/dashboard-chile.png"></p>